 ...
 * @since 5.5
 */
class DWAYLANDSERVER_EXPORT DDESeatInterface : public Global
{
    Q_OBJECT
public:
 ...
 * @since 5.4
 **/
class DWAYLANDSERVER_EXPORT DDEPointerInterface : public Resource
{
    Q_OBJECT
public:
 ...
 * @since 5.4
 **/
class DWAYLANDSERVER_EXPORT DDETouchInterface : public Resource
{
    Q_OBJECT
public:
