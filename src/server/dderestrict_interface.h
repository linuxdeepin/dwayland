...
*********************************************************************/
#ifndef KWAYLAND_SERVER_DDERESTRICT_INTERFACE_H
#define KWAYLAND_SERVER_DDERESTRICT_INTERFACE_H
...
class KWAYLANDSERVER_EXPORT DDERestrictInterface : public Global
{
    Q_OBJECT
public:
